...
var addItem = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.addItem(quantity, orderId, itemId)];
            case 2:
                addedItem = _a.sent();
                res.json(addedItem);
                return [3 /*break*/, 4];
...
var submit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.submit(orderId)];
            case 2:
                submittedOrder = _a.sent();
...
var currentOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.currentOrder(username)];
            case 2:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 4];
...
var completedOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.completedOrders(username)];
            case 2:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 4];
