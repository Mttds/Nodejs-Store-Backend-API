...
var products_2 = __importDefault(require("./handlers/products"));
...
app.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                products = _a.sent();
                res.send("Our Products: ".concat(products));
                return [2 /*return*/];
        }
    });
}); });
...
(0, products_2.default)(app); // /products routes
(0, users_1.default)(app); // /users route
(0, orders_1.default)(app); // /orders routes
(0, dashboard_1.default)(app); // /dashboard routes
