...
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, sql2, hash, result, user, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        ...
                        sql2 = "SELECT id FROM users WHERE username = $1";
                    ...
                    case 2:
                        ...
                        if (result.rows[0] != undefined && 'id' in result.rows[0]) {
                            throw new Error("There is already an user with the same username (".concat(u.username, ") in the Database."));
                        }
                    ...
                    case 4:
                        err_3 = _a.sent();
                        throw new Error("Unable to create user (".concat(u.username, "): ").concat(err_3));
