...
var DashboardQueries = /** @class */ (function () {
    ...
    DashboardQueries.prototype.productInOrders = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'SELECT name, quantity, order_id, username FROM products a JOIN order_items b ON a.id = b.item_id';
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Unable to get items and orders: ".concat(err_1));
